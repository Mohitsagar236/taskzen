/*
  ...
  1. New Tables
    - `notification_preferences` for managing notification settings
    - `browser_extension_data` for storing data from Chrome extension
    - `productivity_reports` for weekly analytics
    - `screen_recordings` for task feedback recordings

  2. Changes
    - Add new columns to `tasks` table for export and recording features
