/*
  ...
  1. Task export formats and history
  2. Screen recording integration
  ...
  - Create tables for notification preferences
  - Create tables for browser extension data
  - Create tables for productivity reports
  - Create tables for screen recordings
